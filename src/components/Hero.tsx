        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="mb-12 animate-fade-in">
            <div className="relative inline-block">
              <div className="absolute inset-0 bg-gradient-to-r from-teal-200 to-cyan-200 dark:from-teal-700 dark:to-cyan-700 rounded-full blur-lg opacity-30 scale-110"></div>
              <img 
                src="/profile.png"
                alt="Mohd Shoaib Rayeen"
                className="relative w-56 h-56 rounded-full mx-auto shadow-2xl border-4 border-white dark:border-slate-800 object-cover ring-4 ring-teal-100 dark:ring-teal-900"
              />
            </div>
          </div>
          ...
          <div className="space-y-6">
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-teal-600 via-cyan-600 to-emerald-600 dark:from-teal-400 dark:via-cyan-400 dark:to-emerald-400 bg-clip-text text-transparent animate-fade-in">
              Mohd Shoaib Rayeen
            </h1>
            
            <h2 className="text-2xl md:text-3xl text-gray-700 dark:text-gray-300 font-semibold animate-fade-in-delay-1">
              Technical Lead I
            </h2>
            
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed animate-fade-in-delay-2">
